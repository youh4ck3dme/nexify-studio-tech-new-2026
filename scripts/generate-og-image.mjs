...
const iconPath = path.join(publicDir, "icons/android-chrome-512x512.png");
...
<svg width="1200" height="630" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="${textLeft}" y="280" font-family="Georgia, serif" font-size="96" font-weight="700" fill="#1D1D1F">KEstudio</text>
  ...
  <rect x="${textLeft}" y="400" width="120" height="4" fill="#E53935"/>
  <text x="${textLeft}" y="480" font-family="ui-sans-serif, sans-serif" font-size="22" fill="#6E6E73">kestudio.sk</text>
</svg>
`;
